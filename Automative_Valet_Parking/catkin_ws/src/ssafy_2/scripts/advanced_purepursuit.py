...
class pure_pursuit :
    def __init__(self):
        ...
        rospy.Subscriber("/path_changed", String, self.path_changed_callback)
        rospy.Subscriber("/searching_for_parkingspace", String, self.parking_space_callback)
    ...
    def parking_space_callback(self, msg):
        # 여기에 주차장 자리에 Object 있는지 확인

    def path_changed_callback(self, msg):
        self.velocity_list = self.vel_planning.curvedBaseVelocity(self.global_path, 500)
        print("Path Changed!!!!")
