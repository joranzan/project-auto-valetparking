...
def srv_client(file_name, seq_num):
    ...
    while not rospy.is_shutdown():
        ...
        end_publisher.publish(seq_num)
        rate.sleep()


if __name__ == '__main__':
    try:
        srv_client(sys.argv[1], int(sys.argv[2]))
