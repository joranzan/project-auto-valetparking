...
class pure_pursuit :
    def __init__(self):
        ...
        self.auto_park_on = rospy.Publisher('auto_park_on', Int8, queue_size=1)
...
class velocityPlanning:
    ...
    def curvedBaseVelocity(self, gloabl_path, point_num):
        out_vel_plan = []
        for i in range(0,len(gloabl_path.poses)):
